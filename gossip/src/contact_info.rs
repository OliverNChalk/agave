...
const SOCKET_TAG_RETRANSMIT: u8 = 14;
const_assert_eq!(SOCKET_CACHE_SIZE, 15);
const SOCKET_CACHE_SIZE: usize = SOCKET_TAG_RETRANSMIT as usize + 1usize;
...
impl ContactInfo {
    ...
    get_socket!(retransmit, SOCKET_TAG_RETRANSMIT);
    ...
    set_socket!(set_retransmit, SOCKET_TAG_RETRANSMIT);
