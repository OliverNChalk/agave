...
pub fn execute(
    ...
    let mut validator_config = ValidatorConfig {
        ...
        enable_scheduler_bindings: matches.is_present("enable_scheduler_bindings")
            || matches.is_present("external_scheduler_binary"),
        external_scheduler_binary: matches
            .value_of("external_scheduler_binary")
            .map(PathBuf::from),
        external_scheduler_config: matches
            .value_of("external_scheduler_config")
            .map(PathBuf::from),
