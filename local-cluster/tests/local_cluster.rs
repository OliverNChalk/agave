...
use {
    ...
    solana_core::{
        ...
        validator::{
            BlockGeneratorAccountsOption, BlockGeneratorConfig, BlockVerificationMethod,
            InvalidatorConfig, ValidatorConfig,
        },
    },
    ...
    solana_stake_interface::{
        self as stake, stake_history::Epoch, state::NEW_WARMUP_COOLDOWN_RATE,
    },
...
fn test_mainnet_beta_cluster_type_program_generator() {
    ...
    // `solana_sdk::system_instruction::MAX_PERMITTED_DATA_LENGTH` accounts to avoid too large
